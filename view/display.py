...
def display_main_page():
    ...
    try:
        ...
        st.image(image, caption="Logo Projet Leadtime IA", use_column_width=True)
    except FileNotFoundError:
        st.write("Logo non trouvé.")
    
    # Description du projet
    st.markdown("""**Leadtime IA** est un projet visant à améliorer la gestion des achats, de la logistique et des approvisionnements.
                  Ce projet repose sur l'automatisation et l'optimisation des processus métiers à l'aide de l'intelligence artificielle.""")
